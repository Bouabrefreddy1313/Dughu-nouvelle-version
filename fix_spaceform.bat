@echo off
cd /d c:\Users\HP\dughu

REM Use Node.js with multiple strategies
node -e "const fs=require('fs');const path='src/components/pages/SpaceFormPage.tsx';const content=fs.readFileSync(path+'.new','utf8');
