      ...
      <div className="mx-auto max-w-2xl px-2 py-4 sm:px-0">
        <div className="mb-4 flex items-center justify-between px-1">
          <h1 className="flex items-center gap-2 text-xl font-bold text-[#2D2D2D]">
            <Clapperboard size={22} className="text-[#985810]" aria-hidden />
            Capsules
          </h1>
          {userId && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-full bg-[#985810] px-4 py-2 text-[13px] font-semibold text-white shadow-sm transition hover:bg-[#7d480d] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#985810]"
        ...
        {isError ? (
          <div className="rounded-3xl bg-white p-8 text-center shadow-sm border border-gray-100">
            ...
            <button onClick={() => void refetch()} className="mt-3 text-xs font-semibold text-[#985810] hover:underline">
              Réessayer
            </button>
          </div>
