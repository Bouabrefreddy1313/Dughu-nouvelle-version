...
Frontend (`middleware.ts` + guards de composants) : expérience utilisateur, évite d'afficher un bouton inutile.
Backend : seule source de vérité réelle — le frontend ne fait jamais office de barrière de sécurité seule, car il est entièrement inspectable/contournable côté client.
