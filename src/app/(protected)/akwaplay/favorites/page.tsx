...
import { Star, RefreshCw, Film } from "lucide-react"
...
import { getFavoriteVideos } from "@/services/akwaplay/akwaplayVideo.service"
import type { AkwaVideo } from "@/types/akwaplay/akwaplay.types"

export default function AkwaFavoritesPage() {
  ...
  const loadVideos = useCallback(async (pageNum = 1) => {
    ...
    try {
      const result = await getFavoriteVideos(userId, pageNum, signal)
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-[#9a9a9a]">Les vidéos que vous avez sauvegardées</p>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
                ...
                <h3 className="text-white font-semibold">Aucune vidéo favorite</h3>
                <p className="text-[#9a9a9a] text-sm max-w-xs">
                  Marquez des vidéos comme favorites pour les retrouver ici.
                </p>
              </div>
            ) : (
              <div>
