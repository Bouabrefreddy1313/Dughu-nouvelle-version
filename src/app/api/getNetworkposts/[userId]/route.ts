...
export async function GET(
  ...
  try {
    ...
    console.log("GET /getNetworkposts/", dughuUserId, "| page:", page, "| posts:", posts.length, "| hasMore:", hasMore)
    ...
    console.error("GET /getNetworkposts error:", error)
    return NextResponse.json(
      { success: false, message: "Impossible de charger les publications du réseau." },
      { status: 500 }
    )
  }
}